...
Fase 1: Contendo a comparação entre os modelos de linguagem Gemma3:27b, LLama 3.1 70B Instruct, NVIDIA Nemotron 3 Ultra com os métodos SVM e M-BERT na tarefa específica de extração de aspectos do dataset Restaurant-ACOS.

Fase 2: Extração e avaliação dos modelos de LLMs que obtiveram os melhores resultados na 1ª fase, o Gemma3:27b e o modelo NVIDIA Nemotron 3 Ultra, comparados aos métodos estabelecidos como baseline do projeto, SVM e M-BERT na tarefa de identificação do par aspecto-categoria do dataset MEMD-ABSA.
